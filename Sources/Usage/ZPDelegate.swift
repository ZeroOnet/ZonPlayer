...
public class ZPDelegate<Input, Output> {
    public init() {}
...
extension ZPDelegate where Input == Void {
    public func call() -> Output? { call(()) }
    public func callAsFunction() -> Output? { call() }
}

extension ZPDelegate where Input == Void, Output: OptionalProtocol {
    public func call() -> Output { call(()) }
    public func callAsFunction() -> Output { call() }
}

extension ZPDelegate where Output: OptionalProtocol {
